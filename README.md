...
**288 papers** and counting. Last generated from [`data/`](data/) — do not edit this file by hand.
...
|:---:|:---:|:---:|:---:|:---|
| DSGym | James Zou | 2026 | [paper](https://arxiv.org/pdf/2601.16344) [code](https://github.com/fannie1208/DSGym) | Standardized end-to-end evaluation of data-science agents in self-contained execution environments, spanning bioinformatics and prediction tasks. |
| DAB | Shreya Shankar | 2026 | [paper](https://arxiv.org/pdf/2603.20576) [code](https://github.com/ucbepic/DataAgentBench) | Enterprise data agents answering end-to-end natural-language questions over heterogeneous databases, with data integration and unstructured extraction. |
...
| DAComp | Kang Liu | 2025 | [paper](https://arxiv.org/pdf/2512.04324) [code](https://github.com/ByteDance-Seed/DAComp) | Data agents across the full enterprise lifecycle — repository-level SQL pipeline construction and open-ended business analysis. |
...
| PredictiQ | Xiaojun Ma | 2025 | [paper](https://arxiv.org/pdf/2505.17149) [code](https://github.com/Cqkkkkkk/PredictiQ) | Predictive-analysis ability across domains, pairing predictive queries with real datasets and checking text–code alignment. |
| InsightBench | Issam Hadj Laradji | 2025 | [paper](https://arxiv.org/pdf/2407.06423) [code](https://github.com/ServiceNow/insight-bench) | End-to-end business analytics and insight discovery — posing questions, interpreting answers, and summarizing findings (ICLR'25). |
| FDABench | Gao Cong | 2025 | [paper](https://arxiv.org/pdf/2509.02473) [code](https://github.com/fdabench/FDAbench) | Agents in multi-source scenarios, fusing structured (DB) and unstructured (PDF/audio) data into analytical answers and reports. |
| DSBench | Dong Yu | 2025 | [paper](https://arxiv.org/pdf/2409.07703) [code](https://github.com/LiqiangJing/DSBench) | Realistic data-science tasks — cleaning, transformation, visualization, modeling — over long-horizon problems with live data stacks (ICLR'25). |
...
| DataSciBench | Yisong Yue | 2025 | [paper](https://arxiv.org/pdf/2502.13897) [code](https://github.com/THUDM/DataSciBench/) | Data-science tasks with uncertain ground truth, evaluated via a Task–Function–Code framework across the analysis lifecycle. |
...
| Pervasive Annotation Errors Break Text-to-SQL Benchmarks and Leaderboards | Daniel Kang | 2026 | [paper](https://arxiv.org/pdf/2601.08778) [code](https://github.com/uiuc-kang-lab/text_to_sql_benchmarks) | This benchmark evaluates pervasive annotation errors in text-to-SQL datasets, finding over 50% error rates in BIRD and Spider 2.0-Snow that significantly distort agent performance and leaderboard rankings. |
...
|:---:|:---:|:---:|:---:|:---|
| MDBench | Reasoning | 2025 | [paper](https://github.com/jpeper/MDBench) | Multi-document table reasoning, synthetically generated via knowledge-guided prompting. |
...
| ToRR | Reasoning | 2025 | [paper](https://arxiv.org/pdf/2502.19412) [code](https://github.com/IBM/unitxt/blob/main/prepare/benchmarks/torr.py) | Table reasoning and robustness across 10 datasets, probing brittleness to serialization and perturbation. |
| MMTU | Comprehensive | 2025 | [paper](https://arxiv.org/pdf/2506.05587) [code](https://github.com/MMTU-Benchmark/MMTU) | Massive multi-task table understanding — 30K+ questions over 25 real-world table tasks. |
...
| Spider2 | Text2SQL | 2025 | [paper](https://arxiv.org/abs/2411.07763) [code](https://github.com/xlang-ai/Spider2) | Real-world enterprise Text-to-SQL over BigQuery/Snowflake, with long contexts and 100+-line queries. |
...
| TableBench | Reasoning | 2024 | [paper](https://arxiv.org/abs/2408.09174) [code](https://github.com/TableBench/TableBench) | Table QA across 18 fields and 4 complexity levels — fact-checking, numerical reasoning, analysis, and visualization. |
| TQA-Bench | Reasoning | 2024 | [paper](https://arxiv.org/pdf/2411.19504) [code](https://github.com/Relaxed-System-Lab/TQA-Bench) | Multi-table QA with scalable long context (up to 64k tokens) over relational databases. |
| SpreadsheetBench | Reasoning | 2024 | [paper](https://arxiv.org/pdf/2406.14991) [code](https://github.com/RUCKBReasoning/SpreadsheetBench/tree/main/data) | Real-world spreadsheet manipulation from Excel forums — find, extract, modify, calculate, and more. |
...
| KDD'26 | IRG: Modular Synthetic Relational Database Generation with Complex Relational Schemas | Y. C. Tay | [paper](https://arxiv.org/pdf/2312.15187) [code](https://github.com/li-jiayu-ljy/irg) |
...
| ICML'26 | Beyond Static Pipelines: Learning Dynamic Workflows for Text-to-SQL | Wei Xu | [paper](https://arxiv.org/pdf/2602.15564) [code](https://github.com/Satissss/SquRL) |
...
| arXiv'26.05 | FINER-SQL: Boosting Small Language Models for Text-to-SQL | Quoc Viet Hung Nguyen | [paper](https://arxiv.org/pdf/2605.03465) [code](https://github.com/thanhdath/finer-sql) |
...
| NeurIPS'25 | SQL-R1: Training Natural Language to SQL Reasoning Model By Reinforcement Learning | Jian Guo | [paper](https://arxiv.org/pdf/2504.08600) [code](https://github.com/IDEA-FinAI/SQL-R1) |
...
| arXiv'25.11 | MARS-SQL: A multi-agent reinforcement learning framework for Text-to-SQL | Yi R. Fung | [paper](https://arxiv.org/pdf/2511.01008) [code](https://github.com/YangHaolin0526/MARS-SQL) |
...
| arXiv'25.02 | SQL-o1: A Self-Reward Heuristic Dynamic Search Method for Text-to-SQL | Yifan Zhu | [paper](https://arxiv.org/pdf/2502.11741) [code](https://github.com/ShuaiLyu0110/SQL-o1) |
...
| arXiv'24.10 | RSL-SQL: Robust Schema Linking in Text-to-SQL Generation | Xiang Bai | [paper](https://arxiv.org/pdf/2411.00073) [code](https://github.com/Laqcce-cao/RSL-SQL) |
...
| VLDB'24 | Text-to-SQL Empowered by Large Language Models: A Benchmark Evaluation `nl2sql` | Jingren Zhou | [paper](https://arxiv.org/pdf/2308.15363) [code](https://github.com/BeachWang/DAIL-SQL) |
...
| AAAI'23 | RESDSQL: Decoupling Schema Linking and Skeleton Parsing for Text-to-SQL | Hong Chen | [paper](https://arxiv.org/pdf/2302.05965) [code](https://github.com/RUCKBReasoning/RESDSQL) |
...
| EDBT'25 | DBCopilot: Natural Language Querying over Massive Databases via Schema Routing | Zhenyu Zeng | [paper](https://arxiv.org/pdf/2312.03463) [code](https://github.com/tshu-w/DBCopilot) |
| arXiv'23.12 | DB-GPT: Empowering Database Interactions with Private Large Language Models | Faqiang Chen | [paper](https://arxiv.org/pdf/2312.17449) [code](https://github.com/eosphoros-ai/DB-GPT) |
| arXiv'23.07 | C3: Zero-shot Text-to-SQL with ChatGPT `nl2sql` | Dongfang Lou | [paper](https://arxiv.org/pdf/2307.07306) |
| arXiv'23.03 | A comprehensive evaluation of ChatGPT's zero-shot Text-to-SQL capability | Philip S. Yu | [paper](https://arxiv.org/pdf/2303.13547) [code](https://github.com/THU-BPM/chatgpt-sql) |
| ICLR'23 | Binding Language Models in Symbolic Languages | Tao Yu | [paper](https://arxiv.org/pdf/2210.02875) [code](https://github.com/HKUNLP/Binder) |
...
| EMNLP'22 | STAR: SQL Guided Pre-Training for Context-dependent Text-to-SQL Parsing | Yongbin Li | [paper](https://arxiv.org/pdf/2210.11888) [code](https://github.com/AlibabaResearch/DAMO-ConvAI) |
...
| ACL'26 | Towards Robust Real-World Spreadsheet Understanding with Multi-Agent Multi-Format Reasoning | Hongsheng Li | [paper](https://arxiv.org/pdf/2604.12282) [code](https://github.com/renhouxing/SpreadsheetAgent.git) |
...
| AAAI'25 | SheetBrain: A Neuro-Symbolic Agent for Accurate Reasoning over Complex and Large Spreadsheets | Dongmei Zhang | [paper](https://arxiv.org/pdf/2510.19247) [code](https://github.com/microsoft/SheetBrain) |
...
| ICLR'25 | TQA-Bench: Evaluating LLMs for Multi-Table Question Answering | Chen Wang | [paper](https://arxiv.org/pdf/2411.19504) |
...
| ICLR'25 | WorkflowLLM: Enhancing Workflow Orchestration Capability of Large Language Models | Maosong Sun | [paper](https://arxiv.org/pdf/2411.05451) [code](https://github.com/OpenBMB/WorkflowLLM) |
...
| CIDR'25 | Text2SQL is Not Enough: Unifying AI and Databases with TAG | Matei Zaharia | [paper](https://arxiv.org/pdf/2408.14717) [code](https://github.com/TAG-Research/TAG-Bench) |
...
- [awesome-ml-data-quality-papers](https://github.com/SJTU-DMTai/awesome-ml-data-quality-papers) — Training-data quality for ML — data attribution & data selection (sibling SJTU-DMTai list)
- [NL2SQL_Handbook](https://github.com/HKUSTDial/NL2SQL_Handbook) — Continuously-updated handbook of Text-to-SQL techniques
- [Awesome-Tabular-LLMs](https://github.com/SpursGoZmy/Awesome-Tabular-LLMs) — Papers on LLMs for table-related tasks
